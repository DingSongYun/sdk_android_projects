...
import com.happiplay.platform.Constants.PayType;
...
//				pCallback.onCallback(result);
    ...
    /**
     * For Unity : Get Locale Country Info
     * @param cmdid
     * @param data
     */
	public static void getLocaleCountry(int cmdid, String data) {
		String country = "Other";
		String lang = Locale.getDefault().toString();
		System.out.println();
		if ("zh_CN".equalsIgnoreCase(lang)) {
			ExternalCall.instance
					.callUnity(
							cmdid,
							"{\"country\":\""
									+ country
									+ "\",\"langareacode\":\"zh_CN\",\"appleLang\":\"zh-Hans\"}");
			...
			ExternalCall.instance
					.callUnity(
							...
							"{\"country\":\""
									+ country
									+ "\",\"langareacode\":\"zh_TW\",\"appleLang\":\"zh-Hant\"}");
		} else {
			ExternalCall.instance.callUnity(cmdid, "{\"country\":\"" + country
	...
	public static void addShortcut(Context context) {
		...
		if (sharedPref != null) {
			...
			if (flag != 1) {
				...
				Intent shortcut = new Intent(/*Intent.ACTION_CREATE_SHORTCUT*/"com.android.launcher.action.INSTALL_SHORTCUT");
	...
	public static String getChannelId(Context context) {
		return context.getPackageName() + "." + BuildUtils.getGameAppInfo().getChannel();
	}
...
//			activity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
	...
	public static boolean isSFPayType(String type) {
		return PayType.PAY_TYPE_CHINA_MM.equals(type)
				|| PayType.PAY_TYPE_CHINA_TELECOM.equals(type)
				|| PayType.PAY_TYPE_CHINA_UNICOM.equals(type);
	}
